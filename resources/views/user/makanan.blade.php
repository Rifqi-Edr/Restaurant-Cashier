...
<div class="text-center ml-64 pt-6 text-blue-950 font-semibold tabcontent" id="nasi_goreng">
    ...
    <h1 class="text-center pr-96">Makanan</h1>

    <!-- content -->
    <div class="flex items-start max-w-6xl mx-auto mt-7 ml-5 p-4 border rounded-md font-outfit bg-slate-100">        
            ...
            <ul
                ...
                <div data-tab-content="" class=" h-100 w-100 bg-gradient-to-br from-gray-300 to-blue-500 rounded-lg">
                    <div class="block opacity-100" id="makanan" role="tabpanel">
                        <section class="grid grid-cols-2 w-full mx-auto gap-3 mt-1 px-16 pl-4">
                            ...
                            <div class="relative flex w-full max-w-[26rem] flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-lg">
                                ...
                                <div class="relative mx-4 mt-4 overflow-hidden rounded-xl bg-blue-gray-500 bg-clip-border text-white shadow-lg shadow-blue-gray-500/40">
                                    <div class="gambar-menu-cashier w-full h-28 bg-cover rounded-lg" style="background-image: url(/build/images/makanan/nasigoreng.jpeg);">
                                        <img
                                        class = 'object-fill' src="{{ asset('images/' . $makanan->gambar_makanan) }}"
                                ...
                                <div class="grid grid-cols-1">
                                    ...
                                    <div class="pr-3 pl-3 pb-3 items-center">
                                        <a href="{{route('add_to_cart', $makanan->id_makanan)}};"><button type="submit" class="btn btn-primary block w-full select-none rounded-lg bg-blue-500 py-2 mt-1  text-white shadow-md hover:shadow-lg hover:shadow-pink-500/40 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none" data-id ="">Tambah Pesanan</button></a>
                                    </div>
                                </div>
                            </div>
                            @endforeach     
